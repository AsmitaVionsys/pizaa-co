...
function CreateOrder() {
  ...
  const priorityPrice = withPriority ? totalCartPrice * 0.2 : 0; // Add your priority price logic here
...
export async function action({ request }) {
  ...
  store.dispatch(clearCart()); // do not overuse, it will clear all imp data
